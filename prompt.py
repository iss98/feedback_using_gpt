...
4. 학생이 전혀 작성하지 않은 평가요소가 있을 경우에 해당 평가요소에 대한 힌트를, 오개념이 있을때는 틀린 단계를 언급하고 오개념을 예시와 함께 설명하기, 완벽한 답일 경우에는 힌트와 함께 다른 풀이 유도하기, 풀이가 부족할 경우에는 풀이를 상세히 쓰도록 지도하는 피드백을 주세요.
5. 피드백을 주는 과정에서 직접적으로 [모범답안], [학생A 답안], [학생B 답안], [학생C 답안],[학생A 답안 평가], [학생B의 답안 평가], [학생C 답안 평가]을 말하지는 마세요.
